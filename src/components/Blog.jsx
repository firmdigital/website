          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto grid grid-cols-1 gap-8 lg:max-w-4xl sm:grid-cols-2">
              ...
              <div className="flex flex-col items-start gap-x-8 gap-y-6 rounded-3xl p-8 ring-1 ring-gray-900/10 sm:gap-y-10 sm:p-10 sm:col-span-2 lg:flex-row lg:items-center">
                ...
                <a
                  href="#"
                  className="rounded-md hover:-translate-y-1 transition-all duration-300 px-3.5 py-2 text-sm font-semibold leading-6 text-[#449ab7] ring-1 ring-inset ring-[#449ab7]/30 hover:ring-[#449ab7]/40 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#449ab7]"
                >
